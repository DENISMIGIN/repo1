...
GO
-- Create Extended Property MS_Description on [Production].[UnitMeasure]
...
GO
-- Add Default Constraint DF_UnitMeasure_ModifiedDate to [Production].[UnitMeasure]
...
GO
-- Create Index AK_UnitMeasure_Name on [Production].[UnitMeasure]
