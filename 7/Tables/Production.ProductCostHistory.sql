...
GO
-- Create Extended Property MS_Description on [Production].[ProductCostHistory]
...
GO
-- Add Check Constraint CK_ProductCostHistory_EndDate to [Production].[ProductCostHistory]
...
GO
-- Add Check Constraint CK_ProductCostHistory_StandardCost to [Production].[ProductCostHistory]
...
GO
-- Add Default Constraint DF_ProductCostHistory_ModifiedDate to [Production].[ProductCostHistory]
...
GO
-- Create Foreign Key FK_ProductCostHistory_Product_ProductID on [Production].[ProductCostHistory]
