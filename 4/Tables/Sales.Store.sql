...
GO
-- Create Extended Property MS_Description on [Sales].[Store]
...
GO
-- Add Default Constraint DF_Store_ModifiedDate to [Sales].[Store]
...
GO
-- Add Default Constraint DF_Store_rowguid to [Sales].[Store]
...
GO
-- Create Foreign Key FK_Store_BusinessEntity_BusinessEntityID on [Sales].[Store]
...
GO
-- Create Foreign Key FK_Store_SalesPerson_SalesPersonID on [Sales].[Store]
...
GO
-- Create Index AK_Store_rowguid on [Sales].[Store]
