...
GO
-- Create Extended Property MS_Description on [Production].[Culture]
...
GO
-- Add Default Constraint DF_Culture_ModifiedDate to [Production].[Culture]
...
GO
-- Create Index AK_Culture_Name on [Production].[Culture]
