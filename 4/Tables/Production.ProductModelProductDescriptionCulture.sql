...
GO
-- Create Extended Property MS_Description on [Production].[ProductModelProductDescriptionCulture]
...
GO
-- Add Default Constraint DF_ProductModelProductDescriptionCulture_ModifiedDate to [Production].[ProductModelProductDescriptionCulture]
...
GO
-- Create Foreign Key FK_ProductModelProductDescriptionCulture_Culture_CultureID on [Production].[ProductModelProductDescriptionCulture]
...
GO
-- Create Foreign Key FK_ProductModelProductDescriptionCulture_ProductDescription_ProductDescriptionID on [Production].[ProductModelProductDescriptionCulture]
...
GO
-- Create Foreign Key FK_ProductModelProductDescriptionCulture_ProductModel_ProductModelID on [Production].[ProductModelProductDescriptionCulture]
