...
GO
-- Create extended property MS_Description on [Production].[Location]
...
GO
-- Add check constraint CK_Location_Availability to [Production].[Location]
...
GO
-- Add check constraint CK_Location_CostRate to [Production].[Location]
...
GO
-- Add default constraint DF_Location_Availability to [Production].[Location]
...
GO
-- Add default constraint DF_Location_CostRate to [Production].[Location]
...
GO
-- Add default constraint DF_Location_ModifiedDate to [Production].[Location]
...
GO
-- Create index AK_Location_Name on [Production].[Location]
