...
GO
-- Create extended property MS_Description on [HumanResources].[JobCandidate]
...
GO
-- Add default constraint DF_JobCandidate_ModifiedDate to [HumanResources].[JobCandidate]
...
GO
-- Create foreign key FK_JobCandidate_Employee_BusinessEntityID on [HumanResources].[JobCandidate]
...
Print 'Create fulltext index on [HumanResources].[JobCandidate]'
GO
CREATE FULLTEXT INDEX ON [HumanResources].[JobCandidate]
