...
GO
-- Create extended property MS_Description on [Production].[ProductProductPhoto]
...
GO
-- Add default constraint DF_ProductProductPhoto_ModifiedDate to [Production].[ProductProductPhoto]
...
GO
-- Add default constraint DF_ProductProductPhoto_Primary to [Production].[ProductProductPhoto]
...
GO
-- Create foreign key FK_ProductProductPhoto_Product_ProductID on [Production].[ProductProductPhoto]
...
GO
-- Create foreign key FK_ProductProductPhoto_ProductPhoto_ProductPhotoID on [Production].[ProductProductPhoto]
