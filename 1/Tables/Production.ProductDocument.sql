...
GO
-- Create extended property MS_Description on [Production].[ProductDocument]
...
GO
-- Add default constraint DF_ProductDocument_ModifiedDate to [Production].[ProductDocument]
...
GO
-- Create foreign key FK_ProductDocument_Document_DocumentNode on [Production].[ProductDocument]
...
GO
-- Create foreign key FK_ProductDocument_Product_ProductID on [Production].[ProductDocument]
