...
GO
-- Create Extended Property MS_Description on [HumanResources].[EmployeePayHistory]
...
GO
-- Add Check Constraint CK_EmployeePayHistory_PayFrequency to [HumanResources].[EmployeePayHistory]
...
GO
-- Add Check Constraint CK_EmployeePayHistory_Rate to [HumanResources].[EmployeePayHistory]
...
GO
-- Add Default Constraint DF_EmployeePayHistory_ModifiedDate to [HumanResources].[EmployeePayHistory]
...
GO
-- Create Foreign Key FK_EmployeePayHistory_Employee_BusinessEntityID on [HumanResources].[EmployeePayHistory]
