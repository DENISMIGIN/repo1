...
GO
-- Create extended property MS_Description on [Person].[BusinessEntity]
...
GO
-- Add default constraint DF_BusinessEntity_ModifiedDate to [Person].[BusinessEntity]
...
GO
-- Add default constraint DF_BusinessEntity_rowguid to [Person].[BusinessEntity]
...
GO
-- Create index AK_BusinessEntity_rowguid on [Person].[BusinessEntity]
