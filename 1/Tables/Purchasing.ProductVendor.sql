...
GO
-- Create extended property MS_Description on [Purchasing].[ProductVendor]
...
GO
-- Add check constraint CK_ProductVendor_AverageLeadTime to [Purchasing].[ProductVendor]
...
GO
-- Add check constraint CK_ProductVendor_LastReceiptCost to [Purchasing].[ProductVendor]
...
GO
-- Add check constraint CK_ProductVendor_MaxOrderQty to [Purchasing].[ProductVendor]
...
GO
-- Add check constraint CK_ProductVendor_MinOrderQty to [Purchasing].[ProductVendor]
...
GO
-- Add check constraint CK_ProductVendor_OnOrderQty to [Purchasing].[ProductVendor]
...
GO
-- Add check constraint CK_ProductVendor_StandardPrice to [Purchasing].[ProductVendor]
...
GO
-- Add default constraint DF_ProductVendor_ModifiedDate to [Purchasing].[ProductVendor]
...
GO
-- Create foreign key FK_ProductVendor_Product_ProductID on [Purchasing].[ProductVendor]
...
GO
-- Create foreign key FK_ProductVendor_UnitMeasure_UnitMeasureCode on [Purchasing].[ProductVendor]
...
GO
-- Create foreign key FK_ProductVendor_Vendor_BusinessEntityID on [Purchasing].[ProductVendor]
