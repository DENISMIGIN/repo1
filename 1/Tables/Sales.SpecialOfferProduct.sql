...
GO
-- Create extended property MS_Description on [Sales].[SpecialOfferProduct]
...
GO
-- Add default constraint DF_SpecialOfferProduct_ModifiedDate to [Sales].[SpecialOfferProduct]
...
GO
-- Add default constraint DF_SpecialOfferProduct_rowguid to [Sales].[SpecialOfferProduct]
...
GO
-- Create foreign key FK_SpecialOfferProduct_Product_ProductID on [Sales].[SpecialOfferProduct]
...
GO
-- Create foreign key FK_SpecialOfferProduct_SpecialOffer_SpecialOfferID on [Sales].[SpecialOfferProduct]
...
GO
-- Create index AK_SpecialOfferProduct_rowguid on [Sales].[SpecialOfferProduct]
