...
GO
-- Create extended property MS_Description on [Production].[Product]
...
GO
-- Add check constraint CK_Product_Class to [Production].[Product]
...
GO
-- Add check constraint CK_Product_DaysToManufacture to [Production].[Product]
...
GO
-- Add check constraint CK_Product_ListPrice to [Production].[Product]
...
GO
-- Add check constraint CK_Product_ProductLine to [Production].[Product]
...
GO
-- Add check constraint CK_Product_ReorderPoint to [Production].[Product]
...
GO
-- Add check constraint CK_Product_SafetyStockLevel to [Production].[Product]
...
GO
-- Add check constraint CK_Product_SellEndDate to [Production].[Product]
...
GO
-- Add check constraint CK_Product_StandardCost to [Production].[Product]
...
GO
-- Add check constraint CK_Product_Style to [Production].[Product]
...
GO
-- Add check constraint CK_Product_Weight to [Production].[Product]
...
GO
-- Add default constraint DF_Product_FinishedGoodsFlag to [Production].[Product]
...
GO
-- Add default constraint DF_Product_MakeFlag to [Production].[Product]
...
GO
-- Add default constraint DF_Product_ModifiedDate to [Production].[Product]
...
GO
-- Add default constraint DF_Product_rowguid to [Production].[Product]
...
GO
-- Create foreign key FK_Product_ProductModel_ProductModelID on [Production].[Product]
...
GO
-- Create foreign key FK_Product_ProductSubcategory_ProductSubcategoryID on [Production].[Product]
...
GO
-- Create foreign key FK_Product_UnitMeasure_SizeUnitMeasureCode on [Production].[Product]
...
GO
-- Create foreign key FK_Product_UnitMeasure_WeightUnitMeasureCode on [Production].[Product]
...
GO
-- Create index AK_Product_Name on [Production].[Product]
...
GO
-- Create index AK_Product_ProductNumber on [Production].[Product]
...
GO
-- Create index AK_Product_rowguid on [Production].[Product]
