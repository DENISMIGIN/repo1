...
GO
-- Create extended property MS_Description on [Production].[TransactionHistory]
...
GO
-- Add check constraint CK_TransactionHistory_TransactionType to [Production].[TransactionHistory]
...
GO
-- Add default constraint DF_TransactionHistory_ModifiedDate to [Production].[TransactionHistory]
...
GO
-- Add default constraint DF_TransactionHistory_ReferenceOrderLineID to [Production].[TransactionHistory]
...
GO
-- Add default constraint DF_TransactionHistory_TransactionDate to [Production].[TransactionHistory]
...
GO
-- Create foreign key FK_TransactionHistory_Product_ProductID on [Production].[TransactionHistory]
